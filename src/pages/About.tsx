...
function About() {
    return (
        <div className="w-full bg-white">
            <Seo
                title="Sobre a Pinturas Lima | Empresa de Pintura em Curitiba"
                description="Conheça a Pinturas Lima, empresa especializada em pintura residencial e comercial em Curitiba, com foco em qualidade, acabamento e atendimento."
                path="/about"
            />
            <NavigationSection />
